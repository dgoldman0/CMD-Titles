...
contract CMDToken is MultiERC20Forgable {
    ...
    constructor(CMDTitles cmd_, ERC20 kem_) MultiERC20Forgable("Command", "CMD", 100000000000000000, kem_, 100, 10000000000000000000000, 1000000000000000000000000) Democratized(VotingMachine(address(0))) {
        voting = new LocalTitles("CMDTitles", "CMT", cmd_, this, 1000);
    }
}